defmodule Rockelivery.ViaCep.Client do
  ...
  plug Tesla.Middleware.BaseUrl, "http://viacep.com.br/ws/"
  ...
  # Return a struct is better than return the raw body (not_implemented)
  # Create a struct for the client response and verify it with pattern match
